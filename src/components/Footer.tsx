  ...
  return (
    <footer className="bg-slate-900 text-slate-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3">
              {[Github, Twitter, Linkedin].map((Icon, i) => (
                <a key={i} href="#" className="p-2 bg-slate-800 hover:bg-teal-500/20 hover:text-teal-400 rounded-lg transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2.5">
                ...
                <span className="text-slate-400">Student Affairs Office,<br />Main Campus, Building C</span>
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="w-4 h-4 text-teal-400 shrink-0" />
                <span className="text-slate-400">events@campus.edu</span>
              </li>
              <li className="flex items-center gap-2.5">
        ...
        <div className="border-t border-slate-700/50 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
